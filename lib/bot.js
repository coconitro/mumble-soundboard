...
exports.playFile = function (file) {
  if (playing) {
    return console.log('Warning: Already playing.');
  }
  if (!ready) {
    return console.log('Warning: Trying to play too soon. Mumble connection is not ready yet.');
  }
  ...
  filestream.on('error', function(err) {
    console.error('Error: Unable to open file '+file+'.mp3');
  });
